...
function woocommerce_maintmode_options_do_page() {
	...
	<div class="wrap">
		...
		<?php screen_icon(); echo "<h2 class='woo_maint'>" . __( 'Woocommerce Maintenance | Message Mode <span id="donate"><a href="#" target="_blank">Want to say thanks?</a></span>', 'woocommerce-maintenance-mode' ) . "</h2>"; ?>
