...
/*
   ...
   Version: 1
   Description: Add a message or redirect on Woocommerce shop, category and product pages only, not affecting any other parts of your website.
   Plugin URI: http://www.mattroyal.co.za/plugins/woocommerce-maintenance-mode/
   Author: Dana Iser
   Author URI: http://
   Requires at least: 3.8
   Tested up to: 4.2
   Text Domain: woocommerce-maint-mode
   License: GPLv3
  */
